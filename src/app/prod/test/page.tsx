...
import {
  SearchCheck, RotateCcw, AlertTriangle, Shield, Loader2,
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-[18px] items-start">
        ...
        <div className="bg-white border border-[#ebedf2] rounded-[14px] p-[22px] shadow-[0_1px_2px_rgba(16,18,30,.04)]">
          ...
          <p className="text-[12.5px] text-[#8a90a0] mb-[18px]">Submit an order to score against the live database.</p>
          ...
          <div className="flex flex-col gap-3.5">
            ...
            <button
              onClick={handleScore}
              disabled={loading}
              className="mt-1 flex items-center justify-center gap-2 py-[11px] rounded-[10px] bg-[var(--brand)] text-white text-[13.5px] font-semibold cursor-pointer shadow-[0_4px_14px_-4px_var(--brand)] hover:bg-[var(--brand-d)] disabled:opacity-60 transition-colors"
            >
              {loading ? (
                <>
